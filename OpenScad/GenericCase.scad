/* not sure where I got this from originaly…


Useage has been changed
	rounded_cube_case (sx = 100, sy = 50, sz = 50, r = 2.5, wall_thickness = 1.5, generate_box = true, generate_lid = true);
*/

use <MCAD/teardrops.scad>
...
module rounded_cube_case (sx = 100, sy = 50, sz = 50, r = 2.5, wall_thickness = 1.5, generate_box = true, generate_lid = true) 
{
	//Screw hole details
